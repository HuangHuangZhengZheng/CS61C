.globl map
# https://www.learncs.site/assets/files/riscvcard-75f9fb3a791fab6eee17d3cf216f77f0.pdf #
.text
main:
...
map:
    ...
    # THINK: why a0? always the beginning of the ll?
    ### YOUR CODE HERE ###
    lw a0, 0(s0)

    # Call the function in question on that value. DO NOT use a label (be prepared to answer why). because we will not be able to go back?
    # What function? Recall the parameters of "map"
    ### YOUR CODE HERE ###
    jalr s1 # @PKU FlyingPig
    ...
    # recurse
    ### YOUR CODE HERE ###
    jal ra, map # maybe wrong @PKU flying_pig
